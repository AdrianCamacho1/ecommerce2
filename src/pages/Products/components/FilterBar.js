...
export const FilterBar = ({setShow}) => {
  ...
  return (
    <section className="filter bg-wh">
        <div id="drawer-disable-body-scrolling" className={`fixed z-40 h-screen p-5 overflow-y-auto bg-white w-72 dark:bg-gray transition-transhtmlForm left-0 top-0 transhtmlForm-none`} tabIndex="-1" aria-labelledby="drawer-disable-body-scrolling-label" aria-modal="true" role="dialog">
            ...
            <div className="py-4 overflow-y-auto">
                <ul className="text-slate-700 dark:text-slate-100">
                  ...
                  <li className="mt-1 mb-5">
                    <span className="font-semibold bg-black">Other Filters</span>
                    <div className="flex items-center my-1">
                    ...
                    <div className="flex items-center my-1">
                        <input onChange={() => dispatch({type: "TRENDING", payload: {trending: !state.trending}})} checked={state.trending || false} id="trending" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="trending" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Trending</label>
                    </div>
                    <div className="flex items-center my-1">
                        <input onChange={() => dispatch({type: "NEWITEM", payload: {newItem: !state.newItem}})} checked={state.newItem || false} id="newItem" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="only-instock" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">New</label>
                    </div>
                  </li>
